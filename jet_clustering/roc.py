...
#make_signif_2d("nTracks",range(50,250,5),"nTracks","trackpt",[0.0001 * x for x in range(0,200,1)],"<track Pt/ jet pt>")
#print("starting 2d significance plots: pt")
#make_signif_2d("nTracks",range(50,250,5),"nTracks","pt",range(0,1000,50),"Pt [GeV]")
#print("starting 2d significance plots: mass")
#make_signif_2d("nTracks",range(50,250,5),"nTracks","mass",range(0,1000,50),"Mass [GeV]")
#print("starting 2d significance plots: medpt")
#make_signif_2d("nTracks",range(50,250,5),"nTracks","medpt",[0.0001 * x for x in range(0,200,1)],"median track Pt/ jet pt")

#print("starting 2d significance plots: girth")
#make_signif_2d("nTracks",range(50,250,5),"nTracks","girth",[0.01 *x for x in range(0,100,1)],"$1/Pt \Sigma_{i} (Pt_{i} * \Delta R_{i,jet}/R)$")
#print("starting 2d significance plots: pt dispersion")
#make_signif_2d("nTracks",range(50,250,5),"nTracks","pt_dispersion",[0.0001 *x for x in range(0,100,1)],"$1/Pt^{2} \Sigma_{i} (Pt_{i}^{2})$")
#print("starting 2d significance plots: lesHouches")
#make_signif_2d("nTracks",range(50,250,5),"nTracks","lesHouches",[0.0005 *x for x in range(0,100,1)],"$1/Pt \Sigma_{i} (Pt_{i} * (\Delta R_{i,jet}/R)^{0.5})$")
#print("starting 2d significance plots: thrust")
#make_signif_2d("nTracks",range(50,250,5),"nTracks","thrust",[0.0005 *x for x in range(0,100,1)],"$1/Pt \Sigma_{i} (Pt_{i} * (\Delta R_{i,jet}/R)^{2})$")
